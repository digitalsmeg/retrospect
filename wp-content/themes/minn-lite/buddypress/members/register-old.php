  ...
  <div class="page" id="register-page">
    <form action="" name="signup_form" id="signup_form" class="standard-form" method="post" enctype="multipart/form-data">
      ...
      <div class="register-section" id="basic-details-section">
        ...
        <p class="description">Your identifier on the site; may be your email address</p>
        ...
        <div class="editfield field_2 field_terms-of-use required-field visibility-public alt field_type_checkbox">
          <div class="checkbox">
            ...
            <label>
              <input type="checkbox" name="field_2[]" id="field_6_0" value="I accept Retrospect’s Terms of Use" required>
        ...
        <div class="editfield field_4 field_newsletter-sign-up optional-field visibility-adminsonly field_type_checkbox">
          <div class="checkbox">
            ...
            <label>
              <input checked="checked" disabled="" type="checkbox" name="field_4[]" id="field_9_0" value="Send me Retrospect’s weekly newsletter with new prompts, polls, tips, and more">
