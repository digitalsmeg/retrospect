					...
					<tr id="m-<?php bp_message_thread_id(); ?>" class="<?php bp_message_css_class(); ?><?php if ( bp_message_thread_has_unread() ) : ?> unread<?php else: ?> read<?php endif; ?>">
						...
						<td class="thread-options">
							<?php if ( bp_message_thread_has_unread() ) : ?>
								<a class="read button" href="<?php bp_the_message_thread_mark_read_url();?>"><?php _e( 'Mark as Read', 'buddypress' ); ?></a>
							<?php else : ?>
								<a class="unread button" style="background:#005672" href="<?php bp_the_message_thread_mark_unread_url();?>"><?php _e( 'Mark as Unread', 'buddypress' ); ?></a>
							<?php endif; ?>
							<a class="delete button" style="" href="<?php bp_message_thread_delete_link(); ?>"><?php _e( 'Delete', 'buddypress' ); ?></a>
						</td>
					</tr>
