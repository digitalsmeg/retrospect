<div id="buddypress">
	...
	<div class="page" id="activate-page">
		...
		<?php if ( bp_account_was_activated() ) : ?>
			...
			<?php else : ?>
				<p><?php printf( __( 'Your account was activated successfully! You can now <a href="%s">sign in</a> with the username and password you provided when you signed up.', 'buddypress' ), wp_login_url( bp_get_root_domain() ) ); ?></p>
                <p>
                Welcome to the Retrospect community.  You can now write stories and comment on others' stories. Go to My Profile to add a picture of yourself or other information you'd like to share with your readers.
                </p>
			<?php endif; ?>
