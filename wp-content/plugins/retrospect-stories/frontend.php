...
function getStories(){
	jQuery(".ajaxstories").html(loader);
			...
			jQuery.post(jaxurl, {action: 'filterStories', values:values,page:page,wpid:wpid,sorter: jQuery(".sorter").find("option:selected").val() }, function(response) {
