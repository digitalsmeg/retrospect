...
function sendAddEmail(){
	var body = 'Check out this story, <? echo addslashes($add_title); ?> by  <? echo $author; ?>, on Retrospect. Retrospect is a new website where baby boomers (and those who love them) can capture and share their stories and memories. \n\n<? echo $add_permalink; ?>';
	body = encodeURIComponent (body);
	window.location='mailto:?subject=<? echo addslashes($add_title); ?> | Retrospect&body=' + body;
	return false;
}
</script>
<?
